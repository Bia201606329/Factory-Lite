...
#define kapa -2.0
#define ke -2.3
#define time_cruz 600
#define time_drop 3000
...
/********FOR TESTING********
      ...
      RFID_vect_test[3]=0;
/**************************/
if(RFID_result==TAG_BLUE) RFID=0;
else if(RFID_result==TAG_GREEN) RFID=1;
    ...
    if (robot.state==1 && TouchSwitch && cont_ini==0){ //avança (pela esquerda) até detetor fim de curso
    ...
    else if (robot.state==100 && tis>500){  
      setState(2);
    }
   
     else if (robot.state==2 && tis>1000){  //recua ate detetar a direita
     ...
     else if(robot.state == 13 && tis > time_cruz) { 
      setState(14);  
     }
      ...
      else if(robot.state == 29 && tis > time_drop) { 
      setState(30);  
     }
      ...
      else if(robot.state == 31 && IRLine.crosses>=2) { 
      setState(32);  
     }
      else if(robot.state == 32 && MA2==1) { 
      setState(33);  
     }
      ...
      else if(robot.state == 39 && tis > time_drop) { 
      setState(40);  
     }
...
//     }
     ...
     else if(robot.state == 21 && tis>time_drop){
      setState(22);
     }
     ...
     else if(robot.state == 25 && tis > time_cruz){
      setState(26);
     }
